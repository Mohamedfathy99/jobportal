package com.fathy.jobportal.config.web;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void configureApiVersioning(ApiVersionConfigurer configurer) {
            ...
            configurer.useMediaTypeParameter(MediaType.parseMediaType("application/vnd.fathyapp+json"), "v")
    ...
    public void configurePathMatch(PathMatchConfigurer configurer) {
            // _ Variable in lambda expression is unnamed variable,
            // cause variable here is unused so to solve warning
